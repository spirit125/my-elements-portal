import { ref as q, onMounted as Ye, onUnmounted as et } from "vue";
function Ne(e, t) {
  return function() {
    return e.apply(t, arguments);
  };
}
const { toString: tt } = Object.prototype, { getPrototypeOf: fe } = Object, { iterator: G, toStringTag: Pe } = Symbol, Q = /* @__PURE__ */ ((e) => (t) => {
  const n = tt.call(t);
  return e[n] || (e[n] = n.slice(8, -1).toLowerCase());
})(/* @__PURE__ */ Object.create(null)), C = (e) => (e = e.toLowerCase(), (t) => Q(t) === e), Z = (e) => (t) => typeof t === e, { isArray: D } = Array, H = Z("undefined");
function I(e) {
...
const rt = Z("string"), A = Z("function"), _e = Z("number"), M = (e) => e !== null && typeof e == "object", st = (e) => e === !0 || e === !1, V = (e) => {
  if (Q(e) !== "object")
    return !1;
  const t = fe(e);
...
}, it = C("Date"), at = C("File"), ct = C("Blob"), lt = C("FileList"), ut = (e) => M(e) && A(e.pipe), ft = (e) => {
  let t;
...
const U = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : global, Le = (e) => !H(e) && e !== U;
function oe() {
  const { caseless: e } = Le(this) && this || {}, t = {}, n = (r, s) => {
    const o = e && Ue(t, s) || s;
    V(t[o]) && V(r) ? t[o] = oe(t[o], r) : V(r) ? t[o] = oe({}, r) : D(r) ? t[o] = r.slice() : t[o] = r;
  };
  for (let r = 0, s = arguments.length; r < s; r++)
    arguments[r] && z(arguments[r], n);
  return t;
}
const wt = (e, t, n, { allOwnKeys: r } = {}) => (z(t, (s, o) => {
...
const Dt = (e) => {
  ...
  return n(e, 0);
}, kt = C("AsyncFunction"), jt = (e) => e && (M(e) || A(e)) && A(e.then) && A(e.catch), De = ((e, t) => e ? setImmediate : t ? ((n, r) => (U.addEventListener("message", ({ source: s, data: o }) => {
  ...
  A(U.postMessage)
), qt = typeof queueMicrotask < "u" ? queueMicrotask.bind(U) : typeof process < "u" && process.nextTick || De, Ht = (e) => e != null && A(e[G]), a = {
  isArray: D,
  isArrayBuffer: Fe,
  isBuffer: I,
  isFormData: ft,
...
}, Jt = typeof URLSearchParams < "u" ? URLSearchParams : de, Vt = typeof FormData < "u" ? FormData : null, vt = typeof Blob < "u" ? Blob : null, Wt = {
  isBrowser: !0,
  classes: {
    URLSearchParams: Jt,
    FormData: Vt,
...
}, pe = typeof window < "u" && typeof document < "u", ae = typeof navigator == "object" && navigator || void 0, Kt = pe && (!ae || ["ReactNative", "NativeScript", "NS"].indexOf(ae.product) < 0), Xt = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
...
const ve = (e) => {
...
}, ee = typeof fetch == "function" && typeof Request == "function" && typeof Response == "function", We = ee && typeof ReadableStream == "function", Sn = ee && (typeof TextEncoder == "function" ? /* @__PURE__ */ ((e) => (t) => e.encode(t))(new TextEncoder()) : async (e) => new Uint8Array(await new Response(e).arrayBuffer())), Ke = (e, ...t) => {
  try {
    return !!e(...t);
  } catch {
    return !1;
  ...
  return e && !t;
}), Te = 64 * 1024, ce = We && Ke(() => a.isReadableStream(new Response("").body)), X = {
  stream: ce && ((e) => e.body)
};
ee && ((e) => {
...
const Tn = async (e) => {
  ...
  try {
    ...
    if (ce && (c || S && y)) {
      ...
      const F = a.toFiniteNumber(g.headers.get("content-length")), [_, J] = c && Re(
        F,
        K(ge(c), !0)
      ) || [];
      g = new Response(
    ...
    l = l || "text";
    let P = await X[a.findKey(X, l) || "text"](g, e);
...
const Ae = (e) => `- ${e}`, Cn = (e) => a.isFunction(e) || e === null || e === !1, Xe = {
  getAdapter: (e) => {
    ...
    for (let o = 0; o < t; o++) {
      n = e[o];
      let i;
      if (r = n, !Cn(n) && (r = le[(i = String(n)).toLowerCase()], r === void 0))
...
function Ze(e) {
  const t = new L(e), n = Ne(L.prototype.request, t);
...
function Zn() {
  const e = q(null), t = q(null), n = q(!1);
  async function r(s, o = {}) {
    n.value = !0, t.value = null;
    try {
      const i = await E.get(s, o);
      e.value = i.data;
    } catch (i) {
      t.value = i.message || "發生錯誤";
    } finally {
      n.value = !1;
    }
  }
  return { data: e, error: t, loading: n, get: r };
}
function Un(e, t, n) {
  Ye(() => e.addEventListener(t, n)), et(() => e.removeEventListener(t, n));
}
function Yn() {
  const e = q(0), t = q(0);
  return Un(window, "mousemove", (n) => {
    e.value = n.pageX, t.value = n.pageY;
  }), { x: e, y: t };
}
export {
  Un as useEventListener,
  Zn as useGet,
  Yn as useMouse
};
